...
public class SecurityConfiguration {
    ...
    private final String secret = "longenoughsecrettotestencryptasdasdasd";
    ...
    public AuthorizationManager<RequestAuthorizationContext> requestMatcherAuthorizationManager
        ...
        managerBuilder.add(new MvcRequestMatcher(introspector,"/users/**"),AuthorityAuthorizationManager.hasAnyAuthority("SCOPE_ADMIN", "SCOPE_BANK", "SCOPE_USER"));

        managerBuilder.add(new MvcRequestMatcher(introspector,"/accounts/**"),AuthorityAuthorizationManager.hasAnyAuthority("SCOPE_ADMIN", "SCOPE_BANK", "SCOPE_USER"));

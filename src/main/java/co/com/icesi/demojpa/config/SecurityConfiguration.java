...
public class SecurityConfiguration {
    ...
    public AuthorizationManager<RequestAuthorizationContext> requestMatcherAuthorizationManager(HandlerMappingIntrospector introspector){
        ...
        managerBuilder.add(new MvcRequestMatcher(introspector,"/**"), AuthorityAuthorizationManager.hasAnyAuthority("SCOPE_ADMIN"));
        ...
        managerBuilder.add(new MvcRequestMatcher(introspector,"/users/"), AuthorityAuthorizationManager.hasAnyAuthority("SCOPE_BANK","SCOPE_ADMIN"));
